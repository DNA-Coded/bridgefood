    ...
    <div className="bg-card border border-border rounded-lg shadow-sm overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-border">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-bold text-foreground">Gemma Activity</span>
        </div>
        {isRunning && (
          <span className="flex items-center gap-1.5 text-[10px] font-bold text-warning">
        ...
        {!hasActivity && (
          <span className="text-[10px] text-muted-foreground">Waiting for upload</span>
        )}
      </div>
